...
<Library LVVersion="14008000">
	...
	<Item Name="Support" Type="Folder">
		...
		<Item Name="buildMqttTopic-string.vi" Type="VI" URL="../mqtt/support/buildMqttTopic-string.vi"/>
		<Item Name="buildMqttTopic-array.vi" Type="VI" URL="../mqtt/support/buildMqttTopic-array.vi"/>
		<Item Name="cp_for_remove_deps-End of Line Constant (bug fix).vi" Type="VI" URL="../mqtt/support/cp_for_remove_deps-End of Line Constant (bug fix).vi"/>
		<Item Name="cp_for_remove_deps-1D Array to String__ogtk.vi" Type="VI" URL="../mqtt/support/cp_for_remove_deps-1D Array to String__ogtk.vi"/>
		<Item Name="cp_for_remove_deps-String to 1D Array__ogtk.vi" Type="VI" URL="../mqtt/support/cp_for_remove_deps-String to 1D Array__ogtk.vi"/>
	</Item>
